...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_OpenBackground = QtWidgets.QPushButton(self.widget)
        self.pushButton_OpenBackground.setGeometry(QtCore.QRect(120, 10, 191, 31))
        self.pushButton_OpenBackground.setObjectName("pushButton_OpenBackground")
        self.pushButton_OpenSignal = QtWidgets.QPushButton(self.widget)
        self.pushButton_OpenSignal.setGeometry(QtCore.QRect(610, 10, 191, 31))
        self.pushButton_OpenSignal.setObjectName("pushButton_OpenSignal")
        self.splitter_3 = QtWidgets.QSplitter(self.widget)
        self.splitter_3.setGeometry(QtCore.QRect(30, 40, 871, 621))
        ...
        self.spinBox_NOderMomentSignal.setMinimum(4)
